...
async function buildWanAnimate2Graph(referenceImageName, opts = {}, settings = {}, deps = {}) {
  ...
  graph.reference_resize = await nodeFromOrdered(
    'ResizeImageMaskNode',
    ['scale dimensions', opts.W, opts.H, 'center', 'area'],
    { input: ['reference_load', 0] },
    { 'resize_type.width': opts.W, 'resize_type.height': opts.H },
  );
  ...
  graph.performance_resize = await nodeFromOrdered(
    'ResizeImageMaskNode',
    ['scale dimensions', opts.W, opts.H, 'center', 'area'],
