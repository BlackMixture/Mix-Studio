...
function buildQwen21Graph(p, settings, references = []) {
  ...
  graph.sampler = { class_type: 'KSampler', inputs: { model, positive: ['text', 0], negative: ['text', 1], latent_image: latent, seed: p.seed, steps: p.steps || 40, cfg: p.cfg ?? 2.5, sampler_name: 'euler', scheduler: 'simple', denoise: 1 } };
