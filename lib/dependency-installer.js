...
const NODE_PACKS = Object.freeze({
  ...
  h3Turbo: {
    ...
    ref: 'a7624b4c00626a8ae7e78860769389d706565190',
    enforceRevision: true,
  },
  whatdreamscost: {
...
const MODEL_ASSETS = Object.freeze({
  ...
  h3Turbo: [
    ['h3TurboLora', 'loras', hf('larryvrh/MiniMax-H3-Turbo-Lora', 'minimax_h3_turbo_4step_ema_ckpt850.safetensors')],
  ],
  ltxCamera: [
...
const COMPONENTS = Object.freeze({
  ...
  h3r2v: { label: 'MiniMax H3 Reference-to-Video', nodes: ['vhs'], models: ['h3', 'h3Ref'] },
...
async function installComponents({ runtime, settings, components, report = () => {}, options = {} }) {
  ...
  let total = readyNodeIds.length + pythonPackageIds.length + assets.length;
  let completed = 0;
