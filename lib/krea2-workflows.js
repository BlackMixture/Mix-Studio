    ...
    nodes: {
      ...
      depth_source_scale: {
        ...
        inputs: {
          ...
          upscale_method: 'lanczos',
          width: Math.max(64, Math.round(Number(options.width) || 1024)),
          height: Math.max(64, Math.round(Number(options.height) || 1024)),
          crop: 'center',
        },
      },
      depth_model: {
...
module.exports = { buildKrea2DepthControl, buildKrea2LatentInput };
