...
test('GitHub Pages publishes the canonical installer from a branded download page', () => {
  ...
  assert.match(page, /GPU memory capacity, not generation time/);
  assert.match(page, /Measured on RTX PRO 6000/);
  assert.match(page, /Typical Mix Studio timing/);
  ...
  assert.match(page, /Bicycle at dusk/);
  assert.match(page, /Shark breach/);
  assert.match(page, /Five rotating LTX 2\.3 image-to-video examples/);
